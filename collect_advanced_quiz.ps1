...
for ($run = 1; $run -le $maxRuns; $run++) {
    ...
    if ($runsWithNoNewQuestions -ge 5 -and $run -ge 5) {
...
$mdContent = @()
$title = "T" + [char]0x1ed5 + "ng h" + [char]0x1ee3 + "p c" + [char]0x00e2 + "u h" + [char]0x1ecf + "i tr" + [char]0x1eaf + "c nghi" + [char]0x1ec7 + "m CSS & Javascript N" + [char]0x00e2 + "ng Cao"
$mdContent += "# $title"
$sourceText = "Ngu" + [char]0x1ed3 + "n: https://stu-nghia.info/on-css-javascript-nang-cao"
...
# Save Markdown
$mdContent | Out-File -FilePath "cau_hoi_nang_cao.md" -Encoding utf8
Write-Host "Completed! Saved $($uniqueQuestions.Count) unique questions to cau_hoi_nang_cao.md."
